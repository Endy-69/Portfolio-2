...
const WORDS = ["Computer Science Graduate", "Freelance Frontend Developer", "CCTV Camera Oprator", "Freelance Video Editor"];
const TECH_STACK = ["React", "Javascript", "Node.js", "Tailwind"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/Endy-69" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/endale-mekonnen-724742291" },
  { icon: Instagram, link: "https://www.instagram.com/?next=%2F" }
];
